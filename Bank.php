                    ...
                    <div class="col-12  ">
                        ...
                        <div class="col-4 offset-4">
                            ...
                            <div class="form-group">
                                    ...
                                    <input type="text" name="name_user" value="<?= $_POST['name_user'] ?? ""; ?>" id="nameC" class="form-control mb-2" placeholder="ENTER YOUR USER NAME" aria-describedby="helpId">
                                
                                </div>
                                <div class="form-group">
                                    <label for="loan amount">LOAN AMOUNT</label>
                                    <input type="number" name="loan_amount"  value="<?= $_POST['loan_amount'] ?? ""; ?>" id="loan amount" class="form-control mb-2" placeholder="ENTER YOUR USER LOAN ANOUNT" aria-describedby="helpId">
                            
                                </div>
                                <div class="form-group">
                                    <label for="loan_years">loan years</label> 
                                    <input type="number" name="loan_years" value="<?= $_POST['loan_years'] ?? ""; ?>" id="loan_years" class="form-control mb-2" placeholder="ENTER YOUR LOAN YEARS" aria-describedby="helpId">
